...
public class DayTwo {
    ...
    public int partOne() {
        ...
        for (String line : values) {
            String character = String.valueOf(line.charAt(line.indexOf(":") - 1));
            int rangeValueOne = getValueOne(line);
            int rangeValueTwo = getValueTwo(line);
            int lineCount = getLineCount(line, character);
            if (lineCount >= rangeValueOne && lineCount <= rangeValueTwo) {
                count++;
            }
        }
    ...
    public int partTwo() {
        ...
        for (String line : values) {
            String checkData = line.split(": ")[1];
            Character character = String.valueOf(line.charAt(line.indexOf(":") - 1)).charAt(0);

            int positionOne = getValueOne(line) - 1;
            int positionTwo = getValueTwo(line) - 1;

            if ((checkData.charAt(positionOne) == character && checkData.charAt(positionTwo) != character)
                 || (checkData.charAt(positionTwo) == character && checkData.charAt(positionOne) != character)) {
                count++;
            }
        }
        return count;
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Part One: %d", dayTwo.partOne());
        System.out.printf("\nPart Two: %d", dayTwo.partTwo());
    }

    private int getLineCount(String line, String character) {
    ...
    private static final String input = "3-4 t: dttt\n" +
            "5-7 l: llmlqmblllh\n" +
